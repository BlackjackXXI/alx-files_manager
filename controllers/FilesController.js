...
export default class FilesController {
  /**
   * hj.fjhvlvjk
   * fjhgfgdhnjdfgnmdghjmdfmjmjhfmj
   * @param {Response} res afsdadfvadfdfvSAdd
   * @param {Request} req fhkchmfhhhgcnhngv.
   */
   ...
   * hgckjkhngghnfuyb
   * ,jhmjh,jhghjjhm,
   * @param {Request} req hghgfhmggfhmgfhmhm
   * @param {Response} res hgnhgnghnghnghnhnb
   */
  ...
  /**
   * j.h,h,mm,m,.
   * @param {Request} req gbhynhbgyvbnyvguhm
   * @param {Response} res hygnbcbgtbynmj,kjhgjhgvcbgfxd
   */
